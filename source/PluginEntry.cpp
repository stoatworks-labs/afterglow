/**
	...
	`CFFGLPluginInfo` that Afterglow.cpp registers at static-initialisation
	...
	binary: which build it is.
		...
		strings Afterglow.bundle/Contents/MacOS/Afterglow | grep afterglow
*/

extern "C" const char* AfterglowBuildStamp()
{
	return "afterglow " AFTERGLOW_VERSION " built " __DATE__ " " __TIME__;
}
